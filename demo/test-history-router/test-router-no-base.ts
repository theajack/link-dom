...
const router = defineRouter({
    ...
    routes: [
        {
            path: '/demo/test-history-router/index',
            component: () => dom.div.text('index'),
        },
        {
            path: '/demo/test-history-router/a1',
            component: () => dom.div.text('a1'),
        },
        {
            path: '/demo/test-history-router/a2',
...
const App = () => {
    return dom.div.children(
        dom.div.style({ display: 'flex', gap: '10px' }).children(
            routerLink('/demo/test-history-router/index'),
            routerLink('/demo/test-history-router/a1'),
            routerLink('/demo/test-history-router/a2'),
            routerLink('/demo/test-history-router/a3'),
            routerLink.back(),
            routerLink.forward(),
            routerLink.go(-2),
        ),
